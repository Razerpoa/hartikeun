...
export const LandingPage: FC<LandingPageProps> = ({ uiLang, setUiLang }) => {
    ...
    const subjects = {
        en: ["friends", "clients", "kids"],
        id: ["teman", "clients", "anak"],
    };

    const subjectMinWidths = {
        en: { friends: "5ch", clients: "5ch", kids: "4ch" },
        id: { teman: "5ch", clients: "5ch", anak: "4ch" },
    };
        ...
        en: [
            {
                ...
                receiver: "What?, Speak english for god sake",
            },
            {
                sender: "Twin, lwk fr that price pmo sm",
                receiver: "Thank you!",
            },
            {
                sender: "Dad, I was mewing while watching a Roblox stream, that rizz was Ohio style!",
                receiver: "Mewing? Ohio? Son, speak english",
            },
        ],
        id: [
            {
            ...
            {
                sender: "Pak, kok regane luwih larang timbang sepupuku?",
                receiver: "Owalah makasih pak!",
            },
            {
    ...
    const subjectWordIndex = heroWords.findIndex(
        (w) =>
            w.toLowerCase().startsWith("friends") ||
            w.toLowerCase() === "temen",
    );
        ...
        >
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    >
                        <span className="text-brand-amber font-serif font-bold">
                            H
                        </span>
                    </motion.div>
            ...
            <section className="relative flex-1 px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto z-10 flex flex-col md:flex-row items-center justify-center md:justify-between gap-12 md:gap-24 w-full py-12 md:py-0">
                ...
                <div className="flex-1 flex flex-col items-start text-left w-full">
                    <div className="mb-8 md:mb-12 max-w-3xl">
                        <h1
                            className={`text-5xl sm:text-7xl lg:text-8xl font-serif font-black text-white italic leading-[0.9] ${uiLang === "id" ? "tracking-tighter" : ""}`}
                        >
                            {displayHeroWords.map((word, i) => {
                                const currentSubject =
                                    subjects[uiLang][subjectIndex];
                                const currentMinWidth =
                                    subjectMinWidths[uiLang][currentSubject] ??
                                    "7ch";
                                const styles = [
                                    "text-white",
                                ...
                                // Subject word with AnimatePresence for rolling animation
                                if (
                                    subjectWordIndex !== -1 &&
                                    i === subjectWordIndex
                                ) {
                        ...
                        <motion.p
                            initial={
                                hasAnimated ? false : { opacity: 0, y: 20 }
                            }
                            animate={{ opacity: 1, y: 0 }}
                            transition={{
                                duration: 0.8,
                ...
                <motion.div
                    initial={
                        hasAnimated ? false : { opacity: 0, x: 30, scale: 0.95 }
                    }
                    animate={{
                        opacity: 1,
                        x: 0,
                    ...
                    <div className="min-h-[4.5rem] flex items-center justify-start">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                "
                                {
                                    bubbleConversations[uiLang][subjectIndex]
                                        .sender
                                }
                                "
                            </motion.div>
            ...
            <div className="absolute bottom-24 w-screen overflow-hidden opacity-[0.07] pointer-events-none z-0">
                ...
                >
                    {[...Array(10)].map((_, i) => (
                        <span key={i}>
                            Hartikeun Skibidi Sigma Rizz Menyala Abangku Cek
                            Khodam Bray
                        </span>
                    ))}
                </motion.div>
